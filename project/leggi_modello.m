function st = leggi_modello(loc_dir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LEGGI_MODELLO
%
% Legge un file .el contenente la descrizione di un modello a elementi
% finiti discretizzato con elementi solidi.
%   da rifare
% Federico Nanni, Samuele Tocco. 01-2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
